	...
	<div class="row">
		...
		<form class="form-horizontal">
		    ...
		    <label for="studentid" class="col-sm-4 control-label">Student ID</label>
		    	<div class="col-sm-8">
		      	<input type="email" class="form-control" id="studentid1" placeholder="Student ID">
	    		</div>
  		  	</div>
  		  	<div class="form-group">
			...
			<div class="form-group">
			    ...
			    <div class="col-sm-8">
			      <input type="password" class="form-control" id="confirmpassword3" placeholder="Confirm Password">
			    </div>
			</div>
